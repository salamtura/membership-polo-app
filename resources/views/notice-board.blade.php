<x-app-layout>
    ...
    <x-page-body-container>
        <x-page-heading title="Notice board" subtitle="Get updated on current happening in the guard polo club." />
            ...
            <div class="mt-12">
                @foreach ($posts as $post)
                    <div class="p-4 md:w-1/3">
                        <div
                            class="h-full border rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                            <img class="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100"
                                src="{{ $post->image != null ? 'storage/' . $post->image : 'images/notice.png' }}"
                                alt="blog">
                            <div class="p-6">
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                                    {{ \Illuminate\Support\Str::upper($post->postcategory->name) }}</h2>
                                ...
                                <div class="flex items-center flex-wrap mt-4 ">
                                    <a href="/post-details/{{ $post->id }}"
                                        class="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Read
                                        more</a>
                ...
                <div class="p-4 md:w-1/3">
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center flex-wrap ">
                                <button
                                    class="bg-gradient-to-r from-fuchsia-300 to-pink-400 hover:scale-105  shadow-cla-blue px-4 py-1 rounded-lg">Learn
                                    more</button>
