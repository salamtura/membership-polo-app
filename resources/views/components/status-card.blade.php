        ...
        @if ($chukker->status == 'open')
            @if ($booking == null)
                <button type="button" onclick="modalHandler(true)"
                    class="text-white w-full bg-green-900 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-200 font-large rounded-lg text-lg my-3 px-5 py-2 justify-center  text-center">Book
                    Now</button>
            @else
            ...
            @endif
            <span class="ml-1 text-xl font-normal text-black flex items-center gap-2">
                <b>Closes in:</b>
