            ...
            <div class="common-card p-[20px] gap-[30px]" style="flex: 1; border: 1px solid #ddd;">
                ...
                <div class="flex flex-col gap-4">
                    @foreach ($notice_board_items as $item)
                        <x-notice-board-item :datelabel="$item['datelabel']" :day="$item['day']" :title="$item['title']" :description="$item['description']"
                            :players="$item['players']" :breakoutSessions="$item['breakoutSessions']" :time="$item['time']" />
                        @if (!$loop->last)
                            <hr />
                        @endif
                    @endforeach
                            ...
                            <div class="grid md:grid-cols-4 sm:grid-cols-2">
                                <div class="bg-white m-3 p-3 shadow-sm rounded-sm text-center">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-green-500 text-xs"><a href="{{ route('invoices') }}">view
                                                more</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white m-3 p-3 shadow-sm rounded-sm text-center">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-green-500 text-xs"><a href="{{ route('penalties') }}">view
                                                more</a></div>
                                    </div>
                                </div>
                                <div class="bg-white m-3 p-3 shadow-sm rounded-sm text-center">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-green-500 text-xs"><a href="{{ route('chukkers') }}">view
                                                more</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-gray-700">
                                <div class="grid md:grid-cols-2 text-sm">
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <div class="px-4 py-2">
                                            {{ date('d F', strtotime($user->membership->date_of_birth)) }}</div>
                                    </div>
                                </div>
                            </div>
