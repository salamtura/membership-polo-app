<x-app-layout>
    ...
    <div class="">
        <div class="font-400 text-[26px] text-white relative ml-[60px] my-6">Welcome
            back {{ $user->membership->first_name }}!</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="common-card profile-card text-center flex flex-col md:flex-row gap-4">
                    <div class="flex flex-col items-center gap-2">
                        <div class="main-user-pic-70"
                            style="background-image: url({{ $user->membership->profile_photo != null ? 'storage/' . $user->membership->profile_photo : 'images/profile.png' }});">
                        </div>
                        <h1>{{ $user->name }}</h1>
                        <p>Member since {{ substr($user->membership->created_at, 0, 4) }}</p>
                        <div class="pill-success capitalize">{{ $user->membership->membership_status }}</div>
                    </div>
                            ...
                            <div class="flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm mt-2">
                                        Dear Member,<br><br>
                                        Your profile has been restricted due to unpaid invoices or penalties associated
                                        with your profile.
                        ...
                        <div class="grid md:grid-cols-4 sm:grid-cols-2">
                            ...
                            <div class="bg-white m-3 p-3 shadow-sm rounded-sm text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-gray-500 text-xs">Unpaid</div>
                                    <div class="text-green-500 text-xs"><a href="{{ route('subscriptions') }}">view
                                            more</a></div>
                                </div>
                            </div>
                            <div class="bg-white m-3 p-3 shadow-sm rounded-sm text-center">
